...
#         bus_sub_classes = clipretrieval(bus_sub_classes,["bus"])
        ...
        train_sub_classes = more_prompt_for_train
...
#         name = choicek
        ...
        prompts_list_1 = ["photo of a {} is walking in the street",
                        "photo of a {} is walking in the street",
                        "photo of a {} is walking in the street",
                        "photo of a {} is walking in the street",
                        

                        "photo of a {} is riding motorbike in the street",
                        "photo of a {} is riding bicycle in the street",
                        
                        "photo of a {} is riding motorbike in the street",
                        "photo of a {} is riding bicycle in the street",
                        "Photo of a {} in the street",
                          "Photo of a {} in the street",
                          "Photo of a {} in the street",

                       "Photo of a {} in the street",
                       "photo of a {} is running in the street",
                         "Photo of a {} in the street",  "Photo of a {} in the road",   "Photo of a {} in the street at night",      "Photo of the back of a {} in the street"
                         ]
        ...
        person_sub_classes = []
        for name in names:
            for prompts_line in prompts_list_1:
...
#         if random.random() >0.5:
        ...
        if args.classes in sub_classes:
            ...
            prompts = [choice(train_sub_classes)]    
        elif args.classes == "motorcycle":
        ...
        if os.path.isfile(os.path.join(image_path,"image_{}_{}.jpg".format(args.classes,image_cnt))):
            continue
...
if __name__ == '__main__':
    ...
    args.output = os.path.join(args.output, "Cityscapes_Multi_Attention_{}_sub_{}_NoClipretrieval".format(args.classes,args.image_number))
